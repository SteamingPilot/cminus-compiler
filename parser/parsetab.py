...
_lr_productions = [
  ...
  ('program -> procedures','program',1,'p_program_procs','cminus_parser.py',28),
  ('program -> declList procedures','program',2,'p_program_decls','cminus_parser.py',34),
  ('procedures -> procedures procedureDecl','procedures',2,'p_procedures','cminus_parser.py',38),
  ('procedures -> procedureDecl','procedures',1,'p_procedures_decl','cminus_parser.py',42),
  ('declList -> type identifierList SEMICOLON','declList',3,'p_decl','cminus_parser.py',46),
  ('declList -> declList type identifierList SEMICOLON','declList',4,'p_decl_list','cminus_parser.py',51),
  ('procedureDecl -> procedureHead procedureBody','procedureDecl',2,'p_procedure_decl','cminus_parser.py',55),
  ('procedureHead -> functionDecl declList','procedureHead',2,'p_procedure_head_decl','cminus_parser.py',60),
  ...
  ('functionDecl -> type IDENTIFIER LPAREN RPAREN LBRACE','functionDecl',5,'p_function_decl_noparam','cminus_parser.py',79),
  ('procedureBody -> statementList RBRACE','procedureBody',2,'p_procedure_body','cminus_parser.py',85),
  ('paramDeclList -> type varDecl','paramDeclList',2,'p_param_decl_list_decl','cminus_parser.py',90),
  ('paramDeclList -> paramDeclList COMMA type varDecl','paramDeclList',4,'p_param_decl_list','cminus_parser.py',95),
  ('identifierList -> varDecl','identifierList',1,'p_id_list_vardecl','cminus_parser.py',100),
  ('identifierList -> identifierList COMMA varDecl','identifierList',3,'p_id_list','cminus_parser.py',105),
  ('varDecl -> IDENTIFIER','varDecl',1,'p_var_decl_id','cminus_parser.py',110),
  ('varDecl -> IDENTIFIER LBRACKET INTCON RBRACKET','varDecl',4,'p_var_decl_array','cminus_parser.py',115),
  ('varDecl -> IDENTIFIER LBRACKET CHARCON RBRACKET','varDecl',4,'p_var_decl_array_char','cminus_parser.py',120),
  ('type -> CHAR','type',1,'p_type_char','cminus_parser.py',125),
  ('type -> INT','type',1,'p_type_int','cminus_parser.py',130),
  ('type -> FLOAT','type',1,'p_type_float','cminus_parser.py',135),
  ('type -> VOID','type',1,'p_type_void','cminus_parser.py',140),
  ('statement -> assignment','statement',1,'p_statement_assignment','cminus_parser.py',145),
  ('statement -> ifStatement','statement',1,'p_statement_if','cminus_parser.py',150),
  ('statement -> whileStatement','statement',1,'p_statement_while','cminus_parser.py',154),
  ('statement -> ioStatement','statement',1,'p_statement_io','cminus_parser.py',158),
  ('statement -> returnStatement','statement',1,'p_statement_returnn','cminus_parser.py',163),
  ('statement -> exitStatement','statement',1,'p_statement_exit','cminus_parser.py',168),
  ('statement -> compoundStatement','statement',1,'p_statement_compound','cminus_parser.py',173),
  ('statement -> callStatement','statement',1,'p_statemet_callStatement','cminus_parser.py',178),
  ('callStatement -> IDENTIFIER LPAREN RPAREN SEMICOLON','callStatement',4,'p_callStatement','cminus_parser.py',183),
  ('callStatement -> IDENTIFIER LPAREN argList RPAREN SEMICOLON','callStatement',5,'p_callStatement_args','cminus_parser.py',187),
  ('assignment -> variable_def ASSIGN expr SEMICOLON','assignment',4,'p_assignment','cminus_parser.py',192),
  ('variable_def -> IDENTIFIER','variable_def',1,'p_variable_def','cminus_parser.py',197),
  ('variable_def -> IDENTIFIER LBRACKET expr RBRACKET','variable_def',4,'p_variable_def_array','cminus_parser.py',202),
  ('ifStatement -> IF testAndThen ELSE compoundStatement','ifStatement',4,'p_if','cminus_parser.py',207),
  ('ifStatement -> IF testAndThen','ifStatement',2,'p_if_then','cminus_parser.py',213),
  ('testAndThen -> test compoundStatement','testAndThen',2,'p_test_then','cminus_parser.py',219),
  ('test -> LPAREN expr RPAREN','test',3,'p_test','cminus_parser.py',224),
  ('whileStatement -> WHILE whileExpr statement','whileStatement',3,'p_while_stmt','cminus_parser.py',229),
  ('whileExpr -> LPAREN expr RPAREN','whileExpr',3,'p_while_expr','cminus_parser.py',234),
  ('ioStatement -> READ LPAREN variable_def RPAREN SEMICOLON','ioStatement',5,'p_read','cminus_parser.py',239),
  ('ioStatement -> WRITE LPAREN expr RPAREN SEMICOLON','ioStatement',5,'p_write_expr','cminus_parser.py',243),
  ('ioStatement -> WRITE LPAREN stringConstant RPAREN SEMICOLON','ioStatement',5,'p_write_str','cminus_parser.py',250),
  ('returnStatement -> RETURN expr SEMICOLON','returnStatement',3,'p_return_stmt','cminus_parser.py',255),
  ('exitStatement -> EXIT SEMICOLON','exitStatement',2,'p_exit_stmt','cminus_parser.py',260),
  ('compoundStatement -> LBRACE statementList RBRACE','compoundStatement',3,'p_compound_stmt','cminus_parser.py',265),
  ('statementList -> statement','statementList',1,'p_stmt_list_stmt','cminus_parser.py',270),
  ('statementList -> statementList statement','statementList',2,'p_stmt_list','cminus_parser.py',275),
  ('expr -> simpleExpr','expr',1,'p_expr','cminus_parser.py',280),
  ('expr -> expr OR simpleExpr','expr',3,'p_expr_or','cminus_parser.py',285),
  ('expr -> expr AND simpleExpr','expr',3,'p_expr_and','cminus_parser.py',290),
  ('expr -> NOT simpleExpr','expr',2,'p_expr_not','cminus_parser.py',295),
  ('simpleExpr -> addExpr','simpleExpr',1,'p_simple_expr','cminus_parser.py',300),
  ('simpleExpr -> simpleExpr EQ addExpr','simpleExpr',3,'p_simple_expr_eq','cminus_parser.py',305),
  ('simpleExpr -> simpleExpr NE addExpr','simpleExpr',3,'p_simple_expr_ne','cminus_parser.py',310),
  ('simpleExpr -> simpleExpr LE addExpr','simpleExpr',3,'p_simple_expr_le','cminus_parser.py',315),
  ('simpleExpr -> simpleExpr LT addExpr','simpleExpr',3,'p_simple_expr_lt','cminus_parser.py',320),
  ('simpleExpr -> simpleExpr GE addExpr','simpleExpr',3,'p_simple_expr_ge','cminus_parser.py',325),
  ('simpleExpr -> simpleExpr GT addExpr','simpleExpr',3,'p_simple_expr_gt','cminus_parser.py',330),
  ('addExpr -> mulExpr','addExpr',1,'p_add_expr','cminus_parser.py',335),
  ('addExpr -> addExpr PLUS mulExpr','addExpr',3,'p_add_expr_plus','cminus_parser.py',340),
  ('addExpr -> addExpr MINUS mulExpr','addExpr',3,'p_add_expr_minus','cminus_parser.py',346),
  ('mulExpr -> factor','mulExpr',1,'p_mul_expr','cminus_parser.py',351),
  ('mulExpr -> mulExpr TIMES factor','mulExpr',3,'p_mul_expr_times','cminus_parser.py',356),
  ('mulExpr -> mulExpr DIVIDE factor','mulExpr',3,'p_mul_expr_div','cminus_parser.py',361),
  ('factor -> variable','factor',1,'p_factor_var','cminus_parser.py',366),
  ('factor -> constant','factor',1,'p_factor_const','cminus_parser.py',371),
  ('factor -> IDENTIFIER LPAREN RPAREN','factor',3,'p_factor_func','cminus_parser.py',376),
  ('factor -> IDENTIFIER LPAREN argList RPAREN','factor',4,'p_factor_func_args','cminus_parser.py',381),
  ('factor -> LPAREN expr RPAREN','factor',3,'p_factor_expr','cminus_parser.py',386),
  ('variable -> IDENTIFIER','variable',1,'p_variable','cminus_parser.py',391),
  ('variable -> IDENTIFIER LBRACKET expr RBRACKET','variable',4,'p_variable_array','cminus_parser.py',396),
  ('stringConstant -> STRING','stringConstant',1,'p_string_const','cminus_parser.py',401),
  ('constant -> FLOATCON','constant',1,'p_float_const','cminus_parser.py',406),
  ('constant -> INTCON','constant',1,'p_int_const','cminus_parser.py',411),
  ('constant -> CHARCON','constant',1,'p_char_const','cminus_parser.py',416),
  ('argList -> expr','argList',1,'p_arg_list_arg','cminus_parser.py',421),
  ('argList -> argList COMMA expr','argList',3,'p_arg_list','cminus_parser.py',426),
]
